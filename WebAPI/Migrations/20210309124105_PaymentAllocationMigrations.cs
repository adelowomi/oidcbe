...
{
    public partial class PaymentAllocationMigrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepresentativePhoneNumber = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdministrativeFee = table.Column<double>(nullable: false),
                    LegalCharge = table.Column<double>(nullable: false),
                    IsInstalmentalPayment = table.Column<bool>(nullable: false),
                    InitialPaymentPercentage = table.Column<int>(nullable: false),
                    PaymentCycleId = table.Column<int>(nullable: true),
                    PercentagePerCycle = table.Column<int>(nullable: false),
                    PaymentInNumberOfMonths = table.Column<int>(nullable: false),
                    PaymentInNumberOfCycle = table.Column<int>(nullable: false),
                    IsPrimarySale = table.Column<bool>(nullable: false),
                    IsSecondarySale = table.Column<bool>(nullable: false),
                    PricePerSquareMeter = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Offers_PaymentCycles_PaymentCycleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyBankName = table.Column<string>(nullable: true),
                    ConfirmedByAppUserId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentAllocations_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentAllocations_AspNetUsers_ConfirmedByAppUserId",
                        column: x => x.ConfirmedByAppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentAllocations_PaymentMethods_PaymentMethodId",
                        column: x => x.PaymentMethodId,
                        principalTable: "PaymentMethods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentAllocations_PaymentStatuses_PaymentStatusId",
                        column: x => x.PaymentStatusId,
                        principalTable: "PaymentStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentAllocations_PaymentTypes_PaymentTypeId",
                        column: x => x.PaymentTypeId,
                        principalTable: "PaymentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentAllocations_Plots_PlotId",
                        column: x => x.PlotId,
                        principalTable: "Plots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QRCodeCodeLink = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<double>(nullable: false),
                    PaymentStatusId = table.Column<int>(nullable: false),
                    PenaltyCharge = table.Column<double>(nullable: true),
                    InterestRate = table.Column<double>(nullable: true),
                    PaymentDueDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentInstalments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentInstalments_Payments_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentAllocations_AppUserId",
                table: "PaymentAllocations",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentAllocations_ConfirmedByAppUserId",
                table: "PaymentAllocations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentAllocations_PaymentStatusId",
                table: "PaymentAllocations",
                column: "PaymentStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentAllocations_PaymentTypeId",
                table: "PaymentAllocations",
                column: "PaymentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentAllocations_PlotId",
                table: "PaymentAllocations",
                column: "PlotId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentInstalments_PaymentId",
                table: "PaymentInstalments",
                column: "PaymentId");
