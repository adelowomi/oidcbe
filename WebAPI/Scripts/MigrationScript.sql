...
VALUES (N'20210123005016_InitialMigration', N'3.1.8');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210123005237_FireBasePropertyAdded', N'3.1.8');
...
CREATE TABLE [PaymentInstalment] (
    ...
    [Amount] float NOT NULL,
    [PaymentStatusId] int NOT NULL,
    [PenaltyCharge] float NULL,
    [InterestRate] float NULL,
    [PaymentDueDate] datetime2 NOT NULL,
    [PaymentId] int NULL,
    CONSTRAINT [PK_PaymentInstalment] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_PaymentInstalment_Payments_PaymentId] FOREIGN KEY ([PaymentId]) REFERENCES [Payments] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_PaymentInstalment_PaymentMethods_PaymentMethodId] FOREIGN KEY ([PaymentMethodId]) REFERENCES [PaymentMethods] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_PaymentInstalment_PaymentStatuses_PaymentStatusId] FOREIGN KEY ([PaymentStatusId]) REFERENCES [PaymentStatuses] ([Id]) ON DELETE CASCADE
);
...
CREATE INDEX [IX_PaymentInstalment_PaymentId] ON [PaymentInstalment] ([PaymentId]);

GO

CREATE INDEX [IX_PaymentInstalment_PaymentMethodId] ON [PaymentInstalment] ([PaymentMethodId]);

GO

CREATE INDEX [IX_PaymentInstalment_PaymentStatusId] ON [PaymentInstalment] ([PaymentStatusId]);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210131002949_InstalmentMigrations', N'3.1.8');
...
CREATE TABLE [PaymentInstalments] (
    [Id] int NOT NULL IDENTITY,
    [DateCreated] datetime2 NOT NULL,
    [DateModified] datetime2 NOT NULL,
    [IsEnabled] bit NOT NULL,
    ...
    [InterestRate] float NULL,
    [PaymentDueDate] datetime2 NOT NULL,
    CONSTRAINT [PK_PaymentInstalments] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_PaymentInstalments_Payments_PaymentId] FOREIGN KEY ([PaymentId]) REFERENCES [Payments] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_PaymentInstalments_PaymentMethods_PaymentMethodId] FOREIGN KEY ([PaymentMethodId]) REFERENCES [PaymentMethods] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_PaymentInstalments_PaymentStatuses_PaymentStatusId] FOREIGN KEY ([PaymentStatusId]) REFERENCES [PaymentStatuses] ([Id]) ON DELETE CASCADE
);
...
CREATE INDEX [IX_PaymentInstalments_PaymentId] ON [PaymentInstalments] ([PaymentId]);

GO

CREATE INDEX [IX_PaymentInstalments_PaymentMethodId] ON [PaymentInstalments] ([PaymentMethodId]);

GO

CREATE INDEX [IX_PaymentInstalments_PaymentStatusId] ON [PaymentInstalments] ([PaymentStatusId]);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210131003312_AddedPaymentIdToPaymentInstalment', N'3.1.8');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210131004519_RemoveSomeProperties', N'3.1.8');
...
CREATE TABLE [AspNetUsers] (
    ...
    [RepresentativeEmail] nvarchar(max) NULL,
    [RepresentativePhoneNumber] nvarchar(max) NULL,
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210204232956_AddedDepartmnet', N'3.1.8');
...
CREATE TABLE [Offers] (
    ...
    [LegalCharge] float NOT NULL,
    [IsInstalmentalPayment] bit NOT NULL,
    [InitialPaymentPercentage] int NOT NULL,
    [PaymentCycleId] int NULL,
    [PercentagePerCycle] int NOT NULL,
    [PaymentInNumberOfMonths] int NOT NULL,
    CONSTRAINT [PK_Offers] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_Offers_OfferStatuses_OfferStatusId] FOREIGN KEY ([OfferStatusId]) REFERENCES [OfferStatuses] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_Offers_PaymentCycle_PaymentCycleId] FOREIGN KEY ([PaymentCycleId]) REFERENCES [PaymentCycle] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_Offers_Plots_PlotId] FOREIGN KEY ([PlotId]) REFERENCES [Plots] ([Id]) ON DELETE CASCADE
);
...
CREATE INDEX [IX_Offers_PaymentCycleId] ON [Offers] ([PaymentCycleId]);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210209023105_PaymentCycle', N'3.1.8');
...
CREATE TABLE [Offers] (
    ...
    [PercentagePerCycle] int NOT NULL,
    [PaymentInNumberOfMonths] int NOT NULL,
    [PaymentInNumberOfCycle] int NOT NULL,
    [IsPrimarySale] bit NOT NULL,
    [IsSecondarySale] bit NOT NULL,
    [PricePerSquareMeter] float NOT NULL,
    CONSTRAINT [PK_Offers] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_Offers_OfferStatuses_OfferStatusId] FOREIGN KEY ([OfferStatusId]) REFERENCES [OfferStatuses] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_Offers_PaymentCycles_PaymentCycleId] FOREIGN KEY ([PaymentCycleId]) REFERENCES [PaymentCycles] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_Offers_Plots_PlotId] FOREIGN KEY ([PlotId]) REFERENCES [Plots] ([Id]) ON DELETE CASCADE
);
...
CREATE TABLE [PaymentAllocations] (
    ...
    [PaymentReceiptPath] nvarchar(max) NULL,
    [CompanyAccountNumber] nvarchar(max) NULL,
    [CompanyBankName] nvarchar(max) NULL,
    [ConfirmedByAppUserId] int NULL,
    [IsConfirmed] bit NOT NULL,
    [PaymentStatusId] int NOT NULL,
    CONSTRAINT [PK_PaymentAllocations] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_PaymentAllocations_AspNetUsers_AppUserId] FOREIGN KEY ([AppUserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_PaymentAllocations_AspNetUsers_ConfirmedByAppUserId] FOREIGN KEY ([ConfirmedByAppUserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_PaymentAllocations_PaymentMethods_PaymentMethodId] FOREIGN KEY ([PaymentMethodId]) REFERENCES [PaymentMethods] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_PaymentAllocations_PaymentStatuses_PaymentStatusId] FOREIGN KEY ([PaymentStatusId]) REFERENCES [PaymentStatuses] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_PaymentAllocations_PaymentTypes_PaymentTypeId] FOREIGN KEY ([PaymentTypeId]) REFERENCES [PaymentTypes] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_PaymentAllocations_Plots_PlotId] FOREIGN KEY ([PlotId]) REFERENCES [Plots] ([Id]) ON DELETE CASCADE
);
...
CREATE TABLE [Permits] (
    ...
    [PermitTypeId] int NOT NULL,
    [PermitStatusId] int NOT NULL,
    [QRCodeCodeLink] nvarchar(max) NULL,
...
CREATE INDEX [IX_PaymentAllocations_AppUserId] ON [PaymentAllocations] ([AppUserId]);

GO

CREATE INDEX [IX_PaymentAllocations_ConfirmedByAppUserId] ON [PaymentAllocations] ([ConfirmedByAppUserId]);

GO

CREATE INDEX [IX_PaymentAllocations_PaymentMethodId] ON [PaymentAllocations] ([PaymentMethodId]);

GO

CREATE INDEX [IX_PaymentAllocations_PaymentStatusId] ON [PaymentAllocations] ([PaymentStatusId]);

GO

CREATE INDEX [IX_PaymentAllocations_PaymentTypeId] ON [PaymentAllocations] ([PaymentTypeId]);

GO

CREATE INDEX [IX_PaymentAllocations_PlotId] ON [PaymentAllocations] ([PlotId]);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210309124105_PaymentAllocationMigrations', N'3.1.8');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210309130438_RemovedAppUserReference', N'3.1.8');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210309202532_RemovedAppUserReferenceAgain', N'3.1.8');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210320012230_AccountMigration', N'3.1.8');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210320012352_AccountMigrationAgain', N'3.1.8');
